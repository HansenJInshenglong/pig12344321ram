              ...
              actionBlock:^{
                  ...
                  OWSSyncGroupsRequestMessage *syncGroupsRequestMessage = [[OWSSyncGroupsRequestMessage alloc]
                      initWithThread:thread
                             groupId:NSUUID.UUID.UUIDString];
...
//    [envelopeBuilder setType:SSKProtoEnvelopeTypePigramText];
//    [envelopeBuilder setSourceId:source.phoneNumber];
...
//    SSKProtoEnvelopeType envelopeType = SSKProtoEnvelopeTypePigramText;
...
//    [envelopeBuilder setContent:content];
//    NSError *error;
