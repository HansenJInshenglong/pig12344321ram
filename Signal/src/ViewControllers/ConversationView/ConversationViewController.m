...
- (void)messageActionsTranspondMessageToItem:(id<ConversationViewItem>)conversationViewItem {
    ...
    [OWSAlerts showActionSheetFromVC:self title:kPGLocalizeString(@"选择转发对象", nil) message:@"" options:@[@"我的群组" , @"我的好友"] selectedCallback:^(NSInteger index) {
...
- (void)willSendPigramShareCard {
    ...
    [OWSAlerts showActionSheetFromVC:self title:kPGLocalizeString(@"选择分享", nil) message:@"" options:@[@"我的群组" , @"我的好友"] selectedCallback:^(NSInteger index) {
