...
public class LoadingViewController: UIViewController {
    ...
    override public func loadView() {
        ...
        let backgroudImg = UIImageView.init(image: UIImage.init(named: "pg_laugh_image"));
        view.backgroundColor = UIColor.white;
        self.view.addSubview(backgroudImg);
        backgroudImg.mas_makeConstraints { (make) in
            make?.edges.offset();
        }
        

        self.logoView = UIImageView(image: UIImage.init(named: "pigram-logo"));
