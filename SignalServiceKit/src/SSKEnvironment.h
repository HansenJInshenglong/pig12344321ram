...
- (instancetype)initWithContactsManager:(id<ContactsManagerProtocol>)contactsManager
              ...
              signalServiceAddressCache:(SignalServiceAddressCache *)signalServiceAddressCache
                  ...
                  storageServiceManager:(id<StorageServiceManagerProtocol>)storageServiceManager
                    ...
                    offlineReveiver:(OWSMessageReceiver *)offlineReceiver
                    offlineProcessor:(OWSBatchMessageProcessor *)offlineProcessor NS_DESIGNATED_INITIALIZER;
...
@property (atomic, readonly) OWSMessageReceiver *offlineReceiver;
@property (nonatomic, readonly) OWSBatchMessageProcessor *offlineProcessor;
