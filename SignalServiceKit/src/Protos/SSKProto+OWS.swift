...
//    var memberAddresses: [SignalServiceAddress] {
        // Parse legacy pre-uuid group members that are not represented in the members list
//        let legacyMembers = members.filter { e164 in members.first { $0 == e164 } == nil }.map { SignalServiceAddress(phoneNumber: $0) }
//
//        return members.map { SignalServiceAddress(uuidString: nil, phoneNumber: $0) } + legacyMembers
//    }
}
