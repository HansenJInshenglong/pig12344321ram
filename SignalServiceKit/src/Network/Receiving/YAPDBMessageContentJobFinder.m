                   ...
                   transaction:(YapDatabaseReadWriteTransaction *)transaction
{
    ...
    SSKProtoEnvelope *envelope = job.envelope;
    [job setUniqueId_PG:[[NSString alloc] initWithFormat:@"%llu-%@",envelope.timestamp,envelope.sourceId]];
