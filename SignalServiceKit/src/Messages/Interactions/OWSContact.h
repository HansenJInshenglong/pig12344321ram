...
typedef NS_ENUM(NSUInteger, PGMessageShareType) {
    PGMessageShareTypeUnknow,
    PGMessageShareTypePersonal,
    PGMessageShareTypeGroup,
} ;

/**
 * 名片分享
 */
@interface PGMessageShare : MTLModel

/**
 * 分享的id
 */
@property (nonatomic, copy) NSString * _Nullable shareID;
/**
 * 分享的名称
 */
@property (nonatomic, copy) NSString * _Nullable shareName;

/**
 * 分享的图像
 */
@property (nonatomic, copy) NSString * _Nullable shareAvatar;
