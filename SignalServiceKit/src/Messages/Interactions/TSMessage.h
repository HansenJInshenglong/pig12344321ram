...
typedef NS_ENUM(NSUInteger, PGMessageContentType) {
    PGMessageContentTypeUnknow,
    PGMessageContentTypeText,
    PGMessageContentTypeImage,
    PGMessageContentTypeGif,
    PGMessageContentTypeAudio,
    PGMessageContentTypeVideo,
    PGMessageContentTypeFile,
    PGMessageContentTypeCard,
};
...
@property (nonatomic, strong, nullable) PGMessageShare *messageShare;
/**
 * 消息内容类型
 */
@property (nonatomic, assign) PGMessageContentType contentType;
 ...
 * 被@的人
 */
@property (nonatomic, copy) NSArray<PigramGroupMember *> *mentions;
 ...
 *
 */
- (TSMessage *)convertMessageToNewOutgoingMessageWithThread:(TSThread *)thread;

- (void)resetBody:(NSString *)newBody;
