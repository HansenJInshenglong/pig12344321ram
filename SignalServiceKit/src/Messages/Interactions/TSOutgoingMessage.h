...
typedef NS_ENUM(NSInteger, TSGroupMetaMessage) {
    ...
    TSGroupMetaMessageJoin,
    ///处理申请入群
    TSGroupMetaMessageJoinHandled,
    TSGroupMetaMessageDismiss
};
 ...
 */
- (void)updateWithSentRecipient:(SignalServiceAddress *)recipientAddress
wasSentByUD:(BOOL)wasSentByUD serverTimestamp:(NSNumber *)timestamp
transaction:(SDSAnyWriteTransaction *)transaction;
