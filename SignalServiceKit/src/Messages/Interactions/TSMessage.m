...
- (NSString *)previewTextWithTransaction:(SDSAnyReadTransaction *)transaction
{
    ...
    } else if (self.messageShare) {
        NSArray *array = @[NSLocalizedString(@"未知类型",nil),NSLocalizedString(@"个人名片",nil),NSLocalizedString(@"群名片",nil)];
        NSString *text = array[self.messageShare.shareType];
        return [[text stringByAppendingString:@" "] stringByAppendingString:@"👤"];
