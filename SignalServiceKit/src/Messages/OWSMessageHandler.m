...
- (NSString *)descriptionForContent:(SSKProtoContent *)content
{
    ...
    } else if (content.friendMessage) {
        
        return [NSString stringWithFormat:@"<friendMessage: %@ />", content.friendMessage];

    } else if (content.groupOperation) {
        
        return [NSString stringWithFormat:@"<groupOperation: %@ />", content.groupOperation];
