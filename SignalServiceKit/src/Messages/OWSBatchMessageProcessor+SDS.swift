...
extension OWSMessageContentJob: SDSModel {
    ...
    public var sdsTableName: String {
        return MessageContentJobRecord.databaseTableName
    }
...
extension OWSMessageContentJobSerializer {
    ...
    public static let table = SDSTableMetadata(collection: OWSMessageContentJob.collection(),
...
class OWSMessageContentOffLineJobSerializer: SDSSerializer {

    private let model: OWSMessageContentOfflineJob
    public required init(model: OWSMessageContentOfflineJob) {
        self.model = model
    }
