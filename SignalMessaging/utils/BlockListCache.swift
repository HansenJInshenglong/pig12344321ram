...
public class BlockListCache: NSObject {
    ...
    private var blockedGroupIds: Set<String> = Set()
    ...
    public func isBlocked(groupId: String) -> Bool {
        return serialQueue.sync {
    ...
    private func update(blockedPhoneNumbers: Set<String>, blockedUUIDs: Set<String>, blockedGroupIds: Set<String>) {
        serialQueue.sync {
