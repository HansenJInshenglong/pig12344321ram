...
- (void)loadView
{
    ...
    UIImageView *backgroupImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"pg_laugh_image"]];
    [self.view addSubview:backgroupImg];
    [backgroupImg mas_makeConstraints:^(MASConstraintMaker *make) {
        make.edges.offset(0);
    }];
    ...
    UIImage *image = [UIImage imageNamed:@"pigram-logo"];
