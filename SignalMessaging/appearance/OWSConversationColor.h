...
@property (class, readonly, nonatomic) UIColor *ows_pigramThemeColor;
...
@property (class, readonly, nonatomic) UIColor *ows_pigramThemeTintColor;
...
@property (class, readonly, nonatomic) UIColor *ows_pigramThemeShadeColor;
