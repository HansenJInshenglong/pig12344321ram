...
+ (UIColor *)ows_pigramThemeColor
{
    return [UIColor colorWithRGBHex:0x3ca6ff];
}
...
+ (UIColor *)ows_pigramThemeTintColor
{
    return [UIColor colorWithRGBHex:0x3ca6ff];
}
...
+ (UIColor *)ows_pigramThemeShadeColor
{
    return [UIColor colorWithRGBHex:0x3ca6ff];
}
...
+ (NSArray<OWSConversationColor *> *)allConversationColors
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        allConversationColors = @[
            ...
            [OWSConversationColor conversationColorWithName:ConversationColorNamePigramThemeColor
            primaryColor:self.ows_pigramThemeColor
              shadeColor:self.ows_pigramThemeShadeColor
               tintColor:self.ows_pigramThemeTintColor],
        ];
    });
